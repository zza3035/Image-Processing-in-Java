...
public class Lab3 {
	...
	// x is the vertical coordination and y is the horizontal coordination
	// the 1D array that stores the colour value of each coordination in the sequence of (x,y)'s B value; (x,y)'s G value; (x,y)'s R value; (x,y+1)'s B value ... 
